...
:root {
  ...
  {% set showcase_video_title_color = settings.showcase_video_title_color ? settings.showcase_video_title_color : '' %}
  {% set showcase_video_background_color = settings.showcase_video_background_color ? settings.showcase_video_background_color : '' %}

  {#### CSS Colors #}

  {# Main colors #}

  --showcase-video-title-color: {{ showcase_video_title_color }};
  --showcase-video-background-color: {{ showcase_video_background_color }};
