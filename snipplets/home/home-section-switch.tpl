...
{# NOVO BLOCO: BARRA DE ANÚNCIOS  - INÍCIO #}
{% include 'snipplets/home/home-ad-bar.tpl' %}
{# NOVO BLOCO: BARRA DE ANÚNCIOS  - FIM #}
{% elseif section_select == 'showcase_video' %}

	{#  **** Main categories ****  #}
	{% include 'snipplets/home/home-showcase-videos.tpl' %}
