{# Product payments details - Ajustado para evitar tela em branco #}

{% set installments_info = product.installments_info_from_any_variant %}
{% set hasDiscount = product.maxPaymentDiscount.value > 0 %}

{# Se houver parcelas OU desconto, criamos o modal #}
    ...
    {% embed "snipplets/modal.tpl" with{
                ...
                {{ component('payments/payments-details',
                    {
                        ...
                        spacing_classes: {
                            top_1x: "mt-1", top_2x: "mt-2", top_3x: "mt-3",
                            right_1x: "mr-1", right_2x: "mr-2", right_3x: "mr-3",
                            bottom_1x: "mb-1", bottom_2x: "mb-2", bottom_3x: "mb-3",
                            left_3x: "ml-3",
                        },
                        container_classes : {
        ...
        {% block modal_foot %}
            <div class="text-right">
                <span class="js-modal-close js-fullscreen-modal-close btn-link pull-right" style="cursor:pointer;">{{ 'Volver al producto' | translate }}</span>
            </div>
        {% endblock %}
    {% endembed %}
